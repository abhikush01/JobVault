...
router.get('/job/:jobId/applications', recruiterOnly, JobApplicationController.getJobApplications);
router.put('/application/:applicationId/status', recruiterOnly, JobApplicationController.updateApplicationStatus);

// New route for sending messages to applicants
router.post('/message', recruiterOnly, JobApplicationController.sendMessageToApplicants);
