  ...
  const features = [
    {
      ...
      description: 'Our advanced algorithm matches you with the most relevant opportunities or candidates based on your profile and preferences.',
    },
    {
      icon: <RealTimeIcon fontSize="large" />,
      title: 'Real-time Updates',
      description: 'Stay informed with instant notifications about new opportunities, applications, and matches.',
    },
    {
      ...
      <Box sx={{ flexGrow: 1 }}>
        <HeroSection>
          <Container maxWidth="lg">
            ...
            >
              Connect with the right opportunities and talent. Whether you're looking for a job or searching for the perfect candidate.
            </Typography>
